  ...
  return (
    <div className="relative flex h-screen w-screen flex-col items-center justify-center gap-4">
      <Tabs
        ...
        className="relative z-50 h-[400px] w-[400px]"
      ...
      <div className="text-secondary absolute inset-0 z-0 flex h-full w-full flex-col items-end justify-end gap-2 text-8xl font-bold opacity-30">
        <div>*SELECT DB</div>
        <div>*SELECT DB</div>
        <div>*SELECT DB</div>
        <div>*SELECT DB</div>
